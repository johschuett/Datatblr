...
# Free memory
rm(.a, .b, .com, .el, .row, .y, absNa, answer, answer_absolute, answer_relative, answer_cum_absolute,
   answer_cum_relative, answer_label, pack, relative_total, subquestion, subquestion_label, table_label, table_title, total)
